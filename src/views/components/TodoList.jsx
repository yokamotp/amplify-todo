...
import {
    ...
    selectTodoList,
    updateTodoRealTime,
} from "../../stores/slices/todo/todoSlices";
...
const TodoList = ({ title, defaultDispOfList, isDoneList }) => {
    ...
    const [isDispTodoList, setDispTodoList] = useState(defaultDispOfList);
    ...
    return (
        <Flex flexDir="column" w="100%">
            {isDispTodoList && (
                <VStack align="stretch" maxH="65vh" overflow="scroll">
                    {todoList.length === 0 ? (
